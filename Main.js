...
zindexes.push(zindexes[_zi-1] + 1);
_zi++;
}
...
proxyEditor.id = "peditor";
proxyEditor.value = "";
proxyEditor.placeholder = "interstellar proxy link";
...
okbtn.addEventListener('click', function() { proxyurl = document.getElementById("peditor").value;
proxyEditor.value = ""; });
